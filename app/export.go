...
// export the state of relayer for a genesis file
func (app *RelayerApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string) (
...
func (app *RelayerApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
