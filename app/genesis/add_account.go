	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			if !common.FileExists(genFile) {
				return fmt.Errorf("%s does not exist, run `relayerd init` first", genFile)
			}
...
func addGenesisAccount(cdc *codec.Codec, appState app.GenesisState, addr sdk.AccAddress,
