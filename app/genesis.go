...
// Create the core parameters for genesis initialization for relayer
// note that the pubkey input is this machines pubkey
func RelayerAppGenState(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
...
// NewDefaultGenesisState generates the default state for relayer.
...
func RelayerValidateGenesisState(genesisState GenesisState) error {
...
// RelayerAppGenState but with JSON
func RelayerAppGenStateJSON(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
	appState json.RawMessage, err error) {
	// create the final app state
	genesisState, err := RelayerAppGenState(cdc, genDoc, appGenTxs)
	if err != nil {
		return nil, err
	}
